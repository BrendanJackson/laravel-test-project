...
class RemoveTeamMember implements RemovesTeamMembers
{
    ...
    public function remove($user, $team, $teamMember)
    {
        ...
        $teamMember->user_actions()->create([
            'title' => 'Removed from Team',
            'description' => 'Account removed from team ['.$team.'] by '.$teamMember->name,
            'severity' => 'success'
        ]);
        $user->user_actions()->create([
            'title' => 'Removed User from Team',
            'description' => 'Removed '.$user->name.' from team ['.$team.']',
            'severity' => 'success'
        ]);
